...
const DATABASE_NAME =
  process.env.TASK_MANAGER_API_DATABASE_NAME ?? "taskmanager";
...
const DATABASE_CONNECTION_STRING_SCHEME =
  process.env.TASK_MANAGER_API_DATABASE_CONNECTION_STRING_SCHEME ?? "mongodb";
...
const DATABASE = {
  ...
  CONNECTION_STRING_SCHEME: DATABASE_CONNECTION_STRING_SCHEME,
};
